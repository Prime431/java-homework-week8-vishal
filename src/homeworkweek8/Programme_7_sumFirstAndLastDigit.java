...
/**7. First And Last Digit Sum
        PRIME TESTINGWrite a method named sumFirstAndLastDigit with one parameter of type int called number.
...
public class Programme_7_sumFirstAndLastDigit {
    public static void main(String[] args) { // main method
        ...
        int number = scanner.nextInt(); //storing scanner in number
        scanner.close();
...
public static int sumFirstAndLastDigit(int number) { // instant method with one parameter
        if (number < 0) {
            return -1;
        }
