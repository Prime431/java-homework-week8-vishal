...
public class Programme_16_Point {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("point distance to (0,0):" + first.distance());
        System.out.println("point distance to (second):" + first.distance(second));
        System.out.println("point distance to point2:" + first.distance(2, 2));
    ...
    public double distance(Programme_16_Point another) {
        int xDistance = another.getX() - this.x;
        int yDistance = another.getY() - this.y;
        return Math.sqrt(xDistance * xDistance + yDistance * yDistance);
    }
